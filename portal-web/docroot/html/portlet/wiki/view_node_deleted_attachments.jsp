...
>
	...
	>
		...
		<liferay-ui:search-container-column-text
			...
			name="file-name"
		>
			<img align="left" alt="" border="0" src="<%= HtmlUtil.escapeHREF(themeDisplay.getPathThemeImages()) %>/file_system/small/<%= DLUtil.getFileIcon(fileEntry.getExtension()) %>.png"> <%= TrashUtil.getOriginalTitle(fileEntry.getTitle()) %>
		</liferay-ui:search-container-column-text>
